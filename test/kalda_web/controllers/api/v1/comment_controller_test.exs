defmodule KaldaWeb.Api.V1.CommentControllerTest do
  ...
  describe "POST create comment user stripe subscription" do
  ...
  describe "POST create comment user free subscription" do
  ...
  describe "POST create with unsubscribed user" do
    setup [:register_and_log_in_user]

    test "does not create comment for unsubscribed user", %{
      conn: conn,
      user: _current_user
    } do
      user = Kalda.AccountsFixtures.user()
    ...
    test "does not create post for unsubscribed user with invalid attributes", %{
      conn: conn,
      user: _current_user
    } do
      user = Kalda.AccountsFixtures.user()
