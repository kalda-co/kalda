<article class="content">
  ...
  <div class="text-card">
    ...
    <p>
      Find a private space where you won’t be disturbed. Make sure you are able
      to access Zoom from the device that you’re on. There is no need to book.
      As well as being able to connect from your dashboard, we’ll also email you
      a Zoom link.
    </p>
  </div>
  <div class="text-card">
    <h1>Can I be anonymous?</h1>
    <p>
      Because we connect to the session over Zoom, to be anonymous you’ll need
      to change your Zoom display name. If you feel more comfortable with your
      camera off that’s fine. We do recommend that people keep their camera on,
      so that participants can get a sense of connection.
    </p>
  </div>
  <div class="text-card">
